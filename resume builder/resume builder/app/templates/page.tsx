                ...
                <div key={template.id} className="bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 mb-4">
                      A {template.name.toLowerCase()} design perfect for {template.id === 'professional' ? 'traditional industries' : template.id === 'modern' ? 'creative fields' : 'minimal and clean presentation'}.
                    </p>
                    <Link
                      href={`/builder?template=${template.id}`}
