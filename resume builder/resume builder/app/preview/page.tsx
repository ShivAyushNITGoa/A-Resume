        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="bg-white dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden mb-8">
              ...
              <div className="p-2 md:p-8 bg-gray-200 dark:bg-gray-900 print:p-0 print:bg-white overflow-auto">
                <div
                  className="w-full md:w-[210mm] mx-auto border shadow-lg bg-white print:border-0 print:shadow-none transition-all duration-300"
                  style={{ transform: `scale(${scale / 100})`, transformOrigin: 'top center' }}
                  ref={resumeRef}
                >
                  <TemplateComponent data={resumeData} color={backgroundColor} />
                </div>
              </div>
            </div>
